...
public class PmaySurveyDaoImpl implements PmaySurveyDao {
	...
	String applicantPhotoName = "";
	String bplPhotoName = "";
	String idPhotoName = "";
	String incomeProofPhotoName = "";
	String landPhoto1Name = "";
	String landPhoto2Name = "";
	String locationDetailPhotoName = "";
	String landRecordPhotoName = "";
	String presentInfrontHousePhotoName = "";
	String rationCardPhotoName = "";
	...
	public Map<String, String> addSurvey(PmayAddSurveyData surveyData) {
		...
		if (PmayUtil.chkNull(surveyData.getSurveyId()).equalsIgnoreCase("0.0")
			...
			if (saveSurveyStatus != 0) {
				/*saveHouseStatus = jdbcTemplate.update(connection -> {
					PreparedStatement ps = connection.prepareStatement(PmayMysqlQueries.SAVE_HOUSING_ENHANCEMENT_QUERY);
					ps.setString(1, PmayUtil.convertBlankToNull(surveyData.getHouseRequirementRadio()));
					ps.setInt(2, nextUserSurveyid);
					ps.setString(3, surveyData.getUserId());
					return ps;
				});*/
			...
			int saveSurveyStatus = jdbcTemplate.update(connection -> {
				...
				ps.setString(1, surveyData.getUserId());

				ps.setString(2, PmayUtil.convertBlankToNull(surveyData.getWardDetails()));
				ps.setString(3, surveyData.getSlumRadio());
				ps.setString(4, surveyData.getValidationPendingStatus());

				ps.setString(5, surveyData.getEligibleStatus());
				ps.setString(6, surveyData.getFamilyHeadName());
				ps.setString(7, surveyData.getFatherHusbandName());
				ps.setString(8, applicantPhotoName);
				ps.setString(9, PmayUtil.convertBlankToNull(surveyData.getAdharNo()));

				ps.setString(10, surveyData.getAdharReason());
				ps.setString(11, PmayUtil.convertBlankToNull(surveyData.getIdType()));
				ps.setString(12, PmayUtil.convertBlankToNull(surveyData.getIdNo()));
				ps.setString(13, idPhotoName);

				ps.setString(14, PmayUtil.convertBlankToNull(surveyData.getGenderId()));
				ps.setString(15, PmayUtil.convertBlankToNull(surveyData.getDob()));
				ps.setString(16, PmayUtil.convertBlankToNull(surveyData.getMaritalStatus()));
				ps.setString(17, PmayUtil.convertBlankToNull(surveyData.getReligion()));
				ps.setString(18, PmayUtil.convertBlankToNull(surveyData.getReligionIfOther()));

				ps.setString(19, PmayUtil.convertBlankToNull(surveyData.getCaste()));
				ps.setString(20, surveyData.getNonEligibleReason());

				ps.setString(21, PmayUtil.convertBlankToNull(surveyData.getPresentTown()));
				ps.setString(22, PmayUtil.convertBlankToNull(surveyData.getPresentHouseNo()));
				ps.setString(23, PmayUtil.convertBlankToNull(surveyData.getPresentStreetName()));
				ps.setString(24, PmayUtil.convertBlankToNull(surveyData.getPresentCity()));
				ps.setString(25, PmayUtil.convertBlankToNull(surveyData.getPresentMobileNo()));
				ps.setString(26, surveyData.getIsSameAsPresentAdd());

				ps.setString(27, PmayUtil.convertBlankToNull(surveyData.getPermanentTown()));
				ps.setString(28, PmayUtil.convertBlankToNull(surveyData.getPermanentHouseNo()));
				ps.setString(29, surveyData.getPermanentStreetName());
				ps.setString(30, PmayUtil.convertBlankToNull(surveyData.getPermanentCity()));
				ps.setString(31, PmayUtil.convertBlankToNull(surveyData.getPermanentMobileNo()));
				ps.setString(32, presentInfrontHousePhotoName);
				ps.setString(33, PmayUtil.convertBlankToNull(surveyData.getOwnershipHouse()));

				ps.setString(34, PmayUtil.convertBlankToNull(surveyData.getGeoLatitude())); // geo_lat
				ps.setString(35, PmayUtil.convertBlankToNull(surveyData.getGeoLongitude())); // geo_lon
				ps.setString(36, PmayUtil.convertBlankToNull(surveyData.getHouseRoofType()));
				ps.setString(37, PmayUtil.convertBlankToNull(surveyData.getHouseWallType()));
				ps.setString(38, PmayUtil.convertBlankToNull(surveyData.getDwellinUnitRoom()));

				ps.setString(39, surveyData.getSizeExistingDwelling());
				ps.setString(40, surveyData.getOwnsRadio());
				ps.setString(41, surveyData.getLandinSqm());
				ps.setString(42, landRecordPhotoName);

				ps.setString(43, PmayUtil.convertBlankToNull(surveyData.getHouseRequirementRadio()));
				ps.setString(44, PmayUtil.convertBlankToNull(surveyData.getPattadarName()));
				ps.setString(45, PmayUtil.convertBlankToNull(surveyData.getPattaNo()));
				ps.setString(46, PmayUtil.convertBlankToNull(surveyData.getDagNo()));
				ps.setString(47, PmayUtil.convertBlankToNull(surveyData.getLandAreaPatta()));

				ps.setString(48, surveyData.getLandLength());
				ps.setString(49, surveyData.getLandBreadth());
				ps.setString(50, landPhoto1Name);
				ps.setString(51, landPhoto2Name);
				ps.setString(52, PmayUtil.convertBlankToNull(surveyData.getEmploymentStatus()));

				ps.setString(53, surveyData.getEmploymentStatusName());
				ps.setString(54, surveyData.getIncomeProof());
				ps.setString(55, incomeProofPhotoName);
				ps.setString(56, PmayUtil.convertBlankToNull(surveyData.getBplRadio()));
				ps.setString(57, PmayUtil.convertBlankToNull(surveyData.getBplNo()));

				ps.setString(58, bplPhotoName);
				ps.setString(59, PmayUtil.convertBlankToNull(surveyData.getRationRadio()));
				ps.setString(60, PmayUtil.convertBlankToNull(surveyData.getRationCardNo()));
				ps.setString(61, rationCardPhotoName);
				ps.setString(62, PmayUtil.convertBlankToNull(surveyData.getPreferredAssistanceHfa()));
				ps.setString(63, PmayUtil.convertBlankToNull(surveyData.getBankAccNo()));
				ps.setString(64, PmayUtil.convertBlankToNull(surveyData.getBankId()));

				ps.setString(65, surveyData.getBankBranchName());
				ps.setString(66, PmayUtil.convertBlankToNull(surveyData.getBankIfscCode()));
				ps.setString(67, applicantSignatureName);
				ps.setString(68, surveyData.getIsSubmitted()); // submitted_data
				ps.setString(69, "N"); // deleted_flag
				ps.setString(70, surveyData.getUserId()); // created_by
				ps.setString(71, surveyData.getBankName());
				ps.setString(72, surveyData.getLandAddress());
				ps.setBinaryStream(73, biometric);
				ps.setString(74, PmayUtil.convertBlankToNull(surveyData.getUlbNameId()));
				ps.setString(75, PmayUtil.convertBlankToNull(surveyData.getRequirement()));
				ps.setString(76, surveyData.getSurveyId());
			...
			/*saveHouseStatus = jdbcTemplate.update(connection -> {
				PreparedStatement ps = connection.prepareStatement(PmayMysqlQueries.UPDATE_HOUSING_ENHANCEMENT_QUERY);
				ps.setString(1, PmayUtil.convertBlankToNull(surveyData.getHouseRequirementRadio()));
				ps.setString(2, surveyData.getUserId());
				ps.setString(3, surveyData.getSurveyId());
				return ps;
			});*/
			String[] familyMemberName = surveyData.getFamilyMemberName().split(",");
			String[] familyMemberRelation = surveyData.getFamilyMemberRelation().split(",");
	 ...
	 *******************************/
	String slumApplicantSignatureName = "";
	String slumLocationDetailsPicName = "";
	String slumIdProofPhoto = "";
	String slumApplicantPhoto = "";
	...
	public Map<String, String> addSlumSurvey(PmaySlumAddData pmayAddSurveyData) {
		...
		if (PmayUtil.chkNull(pmayAddSurveyData.getSurveyId()).equalsIgnoreCase("0.0")
			...
			int saveSlumStatus = jdbcTemplate.update(connection -> {
				...
				ps.setString(1, pmayAddSurveyData.getUserId());
				ps.setString(2, PmayUtil.convertBlankToNull(pmayAddSurveyData.getChckSlumRadio()));
				ps.setString(3, pmayAddSurveyData.getSlumFamilyHeadName());
				ps.setString(4, pmayAddSurveyData.getSlumFatherHusbandName());
				ps.setString(5, PmayUtil.convertBlankToNull(pmayAddSurveyData.getSlumAdharNo()));
				ps.setString(6, pmayAddSurveyData.getSlumAdharReason());
				ps.setString(7, PmayUtil.convertBlankToNull(pmayAddSurveyData.getGenderValue()));

				ps.setString(8, PmayUtil.convertBlankToNull(pmayAddSurveyData.getSlumPresentTown()));
				ps.setString(9, PmayUtil.convertBlankToNull(pmayAddSurveyData.getSlumPresentHouseNo()));
				ps.setString(10, pmayAddSurveyData.getSlumPresentStreetName());
				ps.setString(11, PmayUtil.convertBlankToNull(pmayAddSurveyData.getSlumPresentCity()));
				ps.setString(12, PmayUtil.convertBlankToNull(pmayAddSurveyData.getPresentMobileNo()));
				ps.setString(13, pmayAddSurveyData.getSlumIsSameAsPresentAdd());
				ps.setString(14, PmayUtil.convertBlankToNull(pmayAddSurveyData.getSlumPermanentTown()));
				ps.setString(15, PmayUtil.convertBlankToNull(pmayAddSurveyData.getSlumPermanentHouseNo()));
				ps.setString(16, pmayAddSurveyData.getSlumPermanentStreetName());
				ps.setString(17, PmayUtil.convertBlankToNull(pmayAddSurveyData.getSlumPermanentCity()));
				ps.setString(18, PmayUtil.convertBlankToNull(pmayAddSurveyData.getSlumPermanentMobileNo()));

				ps.setString(19, PmayUtil.convertBlankToNull(pmayAddSurveyData.getSlumReligion()));
				ps.setString(20, PmayUtil.convertBlankToNull(pmayAddSurveyData.getSlumCaste()));
				ps.setString(21, PmayUtil.convertBlankToNull(pmayAddSurveyData.getSlumOwnsRadio()));
				ps.setString(22, pmayAddSurveyData.getSlumLandinSqm());
				ps.setString(23, slumApplicantSignatureName);
				ps.setString(24, slumLocationDetailsPicName);
				ps.setString(25, pmayAddSurveyData.getEligibleStatus());
				ps.setString(26, pmayAddSurveyData.getNonEligibleReason());
				ps.setString(27, PmayUtil.convertBlankToNull(pmayAddSurveyData.getWardDetails()));
				ps.setString(28, "N");
				ps.setString(29, "N");
				ps.setString(30, pmayAddSurveyData.getIsSubmittedFlag());
				ps.setString(31, "N");
				ps.setString(32, pmayAddSurveyData.getUserId());
				ps.setString(33, pmayAddSurveyData.getSlumLandAddress());
				ps.setString(34, PmayUtil.convertBlankToNull(pmayAddSurveyData.getSlumIdProof()));
				ps.setString(35, PmayUtil.convertBlankToNull(pmayAddSurveyData.getSlumIdProofNo()));
				ps.setString(36, slumIdProofPhoto);
				ps.setString(37, PmayUtil.convertBlankToNull(pmayAddSurveyData.getUlbNameId()));
				ps.setString(38, PmayUtil.convertBlankToNull(pmayAddSurveyData.getMaritalStatus()));
				ps.setString(39, PmayUtil.convertBlankToNull(pmayAddSurveyData.getReligionIfOther()));
				ps.setString(40, PmayUtil.convertBlankToNull(pmayAddSurveyData.getDob()));
				ps.setBinaryStream(41, biometric);
				ps.setString(42, PmayUtil.convertBlankToNull(pmayAddSurveyData.getGeoLongitude()));
				ps.setString(43, PmayUtil.convertBlankToNull(pmayAddSurveyData.getGeoLatitude()));
				ps.setString(44, slumApplicantPhoto);
				ps.setString(45, pmayAddSurveyData.getSurveyId());
