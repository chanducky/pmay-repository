mainApp
		.controller(
				...
				function($scope, $http, $window, $rootScope, Excel, $timeout,$compile,PagerService) {
					...
					$scope.deletedSurveyReports = function deletedSurveyReports() {
						$(".pmay-loader").css({
							"display" : "block"
						});
						$http.get(baseUrl + 'deletedSurveyReports/').success(
								function(data) {
									$(".pmay-loader").css({
										"display" : "none"
									});
									if (data == "") {
										...
										$scope.deletedServeyReport = data;
										superAdmin.deletedServeyReport = data;
										superAdmin.setDeletedReportPage(1);
									}
								});
					}
					
					$scope.deleteServey = function deleteServey(userSurveyId) {
						$(".pmay-loader").css({
							"display" : "block"
						});
						$http.post(baseUrl + 'deleteServey/', userSurveyId)
					...
					function getSurveyReports() {
						...
						$http.get(baseUrl + 'getAdminsSurveyReports/').success(
								function(data) {
									...
									$scope.superAdminSurveyReport = data;
									superAdmin.superAdminSurveyReport = data;
									$scope.tempSurveyReport = data;
									superAdmin.setReportPage(1);
								});
					}
						...
						$http.get(baseUrl + 'getAllPendingUsers/').success(
								function(data) {
									...
									if (data == "") {
										...
										superAdmin.pendingUsers = data;
										superAdmin.setPendingUserReportPage(1);
									}
								});
					}
					...
					$scope.selectAllSurveyReportData = function selectAllSurveyReportData() {
						...
						angular
								.forEach(
										$scope.superAdminReport.selectedId,
										function(item, key) {
											$scope.superAdminReport.selectedId[key] = $scope.selectedAll;
										});
					}

					$scope.superAdminReport = {}
					$scope.getReportDetailsForDownload = function getReportDetailsForDownload() {
						$(".pmay-loader").css({
							"display" : "block"
						});
						var superAdminReportDataForDownload = [];
						angular.forEach($scope.superAdminReport.selectedId,
								function(item, key) {
									if (item == true) {
										superAdminReportDataForDownload
												.push(key);
									}
								});
						...
						var rowColumnName = {
							...
							"selectedsurveyId" : superAdminReportDataForDownload
						}
						...
						$http
								.post(
									...
									if (data === "true") {
										location.href = "/superAdminReportExcel";
									} else {
										swal({
											position : 'top',
											text : data,
					...
					$scope.resetAll = function resetAll() {
						$scope.searchData = {};
						superAdmin.superAdminSurveyReport = $scope.tempSurveyReport;
						superAdmin.setReportPage(1);
					}
...
/*****************************************************************Function for addSlumData****************************************************************/
					...
					$scope.saveSlumSurvey = function saveSlumSurvey(addSlumSurvey,clickButton) {
						...
						var surveyData = {
							...
							"slumWardDetails" :addSlumSurvey.slumWardDetails,
				...
				/**************************End Non slum new validation****************************/	
					...
					$scope.editSurvryReport = function editSurvryReport(surveyReport) {
						...
						if(surveyReport.slumNonSlum == "S"){
							...
							$scope.addSlumSurvey = {};
							$scope.addSlumSurvey.slumWardDetails = surveyReport.wardId;
						...
						$scope.addSurvey.contactNo=surveyReport.contactNumber;
					...
					$scope.getReportFilteredDataForSuperAdmin = function getReportFilteredDataForSuperAdmin() {
						$(".pmay-loader").css({
							"display" : "block"
						});
						
						var searchData = {
								"searchName" : $scope.searchData.superAdminReportName,
								"aadharOrIdNumber" : $scope.searchData.superAdminReportAadharNo,
								"ulbName" : $scope.searchData.superAdminReportUlbName,
								"fatherSpouseName" : $scope.searchData.superAdminReportFatherSpouseName,
								"bankAccountNo" : $scope.searchData.superAdminReportBankAc,
								"searchScopeName" : $scope.searchData.superAdminReportScopeName,
								"searchScopeValue" : $scope.searchData.superAdminReportScopeValue
						}
						...
						$http
								...
								.success(
										function(surveyReport) {
											...
											if (surveyReport != "") {
												superAdmin.superAdminSurveyReport = surveyReport;
												superAdmin.setReportPage(1);
											} else {
												swal({
													position : 'top',
					...
					$scope.getSurveyedFilteredDataForSuperAdmin = function getSurveyedFilteredDataForSuperAdmin() {
						$(".pmay-loader").css({
							"display" : "block"
						});
						
						var searchData = {
								"searchName" : $scope.searchData.superAdminSurveyName,
								"aadharOrIdNumber" : $scope.searchData.superAdminSurveyAadharNo,
								"ulbName" : $scope.searchData.superAdminSurveyUlbName,
								"fatherSpouseName" : $scope.searchData.superAdminSurveyFatherSpouseName,
								"bankAccountNo" : $scope.searchData.superAdminSurveyBankAc,
								"searchScopeName" : $scope.searchData.superAdminSurveyScopeName,
								"searchScopeValue" : $scope.searchData.superAdminSurveyScopeValue
						}
						...
						$http
								...
								.success(
										function(surveyReport) {
											...
											if (surveyReport != "") {
												$scope.superAdminSurveyData = surveyReport;
											} else {
												swal({
													position : 'top',
													text : "No Result Found",
												...
												$scope.superAdminSurveyData = $scope.tempSurveyReport;
											}
										});
					}
...
/********************Manager Profile Started*****************************/
					
					$scope.getDetailsForSuperAdminMnagerProfile = function getDetailsForSuperAdminMnagerProfile(){
						$(".pmay-loader").css({
							"display" : "block"
						});
						$http.get(baseUrl + 'getDetailsForSuperAdminMnagerProfile/').success(function(data) {
							superAdmin.userDetailsReport = data;
							superAdmin.setUserReportPage(1);
					        $(".pmay-loader").css({
						    "display" : "none"
						    });
						});
					...
					/********************End of Manager Profile*****************************/
					$scope.getSuperAdminFilterForUlbDetails = function getSuperAdminFilterForUlbDetails(superAdminReportParam){
						$(".pmay-loader").css({
							"display" : "block"
						});
						$("#noUlbrecords").hide(); 
						var data = {"searchData" : superAdminReportParam}
...
/***********************************************************Pagination ******** *************************************************/
					...
					superAdmin.reportPager = {};
					superAdmin.setReportPage = setReportPage;
				    getSurveyReports();
					function setReportPage(page) {
						$(".pmay-loader").css({
							"display" : "block"
						});
				        if (page < 1 || page > superAdmin.reportPager.totalPages) {
				        	$(".pmay-loader").css({
								"display" : "none"
							});
				            return;
				        }
				        superAdmin.reportPager = PagerService.GetPager(superAdmin.superAdminSurveyReport.length, page );
				        superAdmin.superAdminSurveyData = superAdmin.superAdminSurveyReport.slice(superAdmin.reportPager.startIndex, superAdmin.reportPager.endIndex + 1);
				        $(".pmay-loader").css({
							"display" : "none"
						});
				    }
					/******************** End Pagination for Survey Report**********************/
					/********************Pagination for Deleted Survey Report**********************/				    
				    //used for survey report
					superAdmin.deletedReportPager = {};
					superAdmin.setDeletedReportPage = setDeletedReportPage;
					$scope.deletedSurveyReports();
					function setDeletedReportPage(page) {
						$(".pmay-loader").css({
							"display" : "block"
						});
				        if (page < 1 || page > superAdmin.deletedReportPager.totalPages) {
				        	$(".pmay-loader").css({
								"display" : "none"
							});
				            return;
				        }
				        superAdmin.deletedReportPager = PagerService.GetPager(superAdmin.deletedServeyReport.length, page );
				        superAdmin.deletedServeyReportData = superAdmin.deletedServeyReport.slice(superAdmin.deletedReportPager.startIndex, superAdmin.deletedReportPager.endIndex + 1);
				        $(".pmay-loader").css({
							"display" : "none"
						});
				    }
					/******************** End Pagination for Deleted Survey Report**********************/					
					/********************Pagination for manager Surveyor Report**********************/				    
				    //used for survey report
					superAdmin.pendingUserPager = {};
					superAdmin.setPendingUserReportPage = setPendingUserReportPage;
					$scope.getAllPendingUsers();
					function setPendingUserReportPage(page) {
						$(".pmay-loader").css({
							"display" : "block"
						});
				        if (page < 1 || page > superAdmin.pendingUserPager.totalPages) {
				        	$(".pmay-loader").css({
								"display" : "none"
							});
				            return;
				        }
				        superAdmin.pendingUserPager = PagerService.GetPager(superAdmin.pendingUsers.length, page );
				        superAdmin.pendingUsersData = superAdmin.pendingUsers.slice(superAdmin.pendingUserPager.startIndex, superAdmin.pendingUserPager.endIndex + 1);
				        $(".pmay-loader").css({
							"display" : "none"
						});
				    }
					...
					superAdmin.userPager = {};
					superAdmin.setUserReportPage = setUserReportPage;
					$scope.getDetailsForSuperAdminMnagerProfile();
					function setUserReportPage(page) {
						$(".pmay-loader").css({
							"display" : "block"
						});
						if (page < 1 || page > superAdmin.userPager.totalPages) {
							$(".pmay-loader").css({
								"display" : "none"
							});
				            return;
				        }
				        superAdmin.userPager = PagerService.GetPager(superAdmin.userDetailsReport.length, page );
				        superAdmin.userDetailsReportData = superAdmin.userDetailsReport.slice(superAdmin.userPager.startIndex, superAdmin.userPager.endIndex + 1);
				        $(".pmay-loader").css({
							"display" : "none"
						});
				    }
					...
					superAdmin.ulbPager = {};
					superAdmin.setUlbDetailsPage = setUlbDetailsPage;
					$scope.getSuperAdminFilterForUlbDetails(searchData);
					function setUlbDetailsPage(page) {
						$(".pmay-loader").css({
							"display" : "block"
						});
						if(page===-1){
							superAdmin.ulbWardsData="";
							superAdmin.ulbPager.pages.length=0;
							$(".pmay-loader").css({
								"display" : "none"
							});
							return;
						}
				        if (page < 1 || page > superAdmin.ulbPager.totalPages) {
				        	$(".pmay-loader").css({
								"display" : "none"
							});
				            return;
				        }
				        superAdmin.ulbPager = PagerService.GetPager(superAdmin.superAdminUserUlbWardsData.length, page ,pageSizeForUlb);
				        superAdmin.ulbWardsData = superAdmin.superAdminUserUlbWardsData.slice(superAdmin.ulbPager.startIndex, superAdmin.ulbPager.endIndex + 1);
				        $(".pmay-loader").css({
							"display" : "none"
						});
				    }
